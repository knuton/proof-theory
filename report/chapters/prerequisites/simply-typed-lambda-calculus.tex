...
We now consider a \emph{typed} version of $\lambda$-calculus.
\footnote{Here we mostly follow the style of \smartcite{lectures}.}
The notion of types is very natural to someone with a background in
programming, but perhaps not so much to someone from the background of
mathematics.
