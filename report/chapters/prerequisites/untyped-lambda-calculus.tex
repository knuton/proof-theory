...
want to able to reduce subterms of any $\lambda$-term so we require that
...
A cruicial property of this relation is exposed by the following theorem.
...
\end{theorem}
\center{\texttt{<insert diagram here>}}
\center{\texttt{<Add necessary corollaries>}}

%% ok, I'm really wasting too much time here, increasing pace!
